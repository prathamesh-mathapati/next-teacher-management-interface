...
const TeacherList = () => {
    ...
    >
      ...
      <td>
        <div className="flex items-center gap-2">
          ...
          {role === "admin" && (
            <button className="w-7 h-7 flex items-center justify-center rounded-full bg-[var(--pm-s)]">
  ...
  return (
    <div className="bg-white p-4 rounded-md flex-1 mt-0 m-4">
      ...
      <div className="">
        <Table columns={columns} data={teachersData} rederRow={rederRow}/>
      </div>
      <div className="">
        <Pagination />
      </div>
